...
<body>
  <div class="wrap">
    <div class="header_top">
      <div class="logo">
        <a href="index.php"><h1 style="font-size:50px;color:gold;">KEMICK</h1></a>
      </div>
        <div class="header_top_right">
          <div class="search_box">
            <form>
              <input type="text" value="Search for items & brands" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search for items & brands';}"><input type="submit" value="SEARCH">
            </form>
          </div>
